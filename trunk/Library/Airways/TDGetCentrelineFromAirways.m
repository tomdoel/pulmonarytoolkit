function results = TDGetCentrelineFromAirways(airway_results, template_image, reporting)
    ...
    airway_segmented_image = TDGetImageFromAirwayResults(airway_results.AirwayTree, template_image, false, reporting);
    ...
    airway_segmented_image = TDFillHolesInImage(airway_segmented_image);
    
    % Skeletonise
    reporting.ShowProgress('Reducing airways to a skeleton');
    skeleton_image = TDSkeletonise(airway_segmented_image, fixed_points, reporting);
