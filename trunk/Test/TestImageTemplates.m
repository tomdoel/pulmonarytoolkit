classdef TestImageTemplates < PTKTest
    ...
    methods
        function obj = TestImageTemplates
            ...
            mock_dataset_results.AddMockResult('PTKGetContextForLungROI', PTKContext.LungROI, mock_roi_image, [], [], true);
            mock_dataset_results.AddMockResult('PTKGetContextForOriginalImage', PTKContext.OriginalImage, mock_full_image, [], [], true);
