classdef PTKDensityVsHeightAxial < PTKPlugin
    % PTKDensityVsHeightAxial. Plugin for showing a graph relating density to
    % distance along the cranial-caudal axis
    %
    ...
    %
    %     PTKDensityVsHeightAxial opens a new window showing the graph.
    %
    %
    %     Licence
    %     -------
    ...
    properties
        ButtonText = 'Density vs axial distance'
        ToolTip = 'Shows a graph of the density vs distance along the cranial-caudal axis'
        Category = 'Analysis'
    ...
    methods (Static)
        function results = RunPlugin(dataset, reporting)
            ...
            figure_filename = fullfile(results_directory, 'DensityVsAxialDistance');
