classdef TDSaveMarkers < TDGuiPlugin
    % TDSaveMarkers. Gui Plugin for saving the current set of markers.
    %
    %     You should not use this class within your own code. It is intended to
    %     be used by the gui of the Pulmonary Toolkit.
    %
    %     TDSaveMarkers is a Gui Plugin for the TD Pulmonary Toolkit.
