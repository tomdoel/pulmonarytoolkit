function results = PTKDrawAirwayGrowingBranchesAsSegmentation(airway_tree, template_image, reporting)
    ...
    while ~isempty(branches_to_do)
        ...
        if isnan(end_point_mm.CoordX)
            reporting.ShowWarning('PTKDrawAirwayGrowingBranchesAsSegmentation:NaNFound', 'The airway growing tree contains invalid end coordinates. This may indicate a failure in the algorithm.', []);
        end
