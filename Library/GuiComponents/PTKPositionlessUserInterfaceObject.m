classdef PTKPositionlessUserInterfaceObject < PTKUserInterfaceObject
    % PTKPositionlessUserInterfaceObject. Base class for PTK user interface
    % components whose Matlab objects do not have an underlying Position property
    %
    %     Use PTKPositionlessUserInterfaceObject for user interface objects which
    ...
    methods
        function obj = PTKPositionlessUserInterfaceObject(parent)
        ...
        function ObjectHasBeenResized(obj)
            % PTKPositionlessUserInterfaceObject has no position, so do nothing
        end
