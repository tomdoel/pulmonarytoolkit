classdef TestMimWebsocketParser < CoreTest
    ...
    methods
        function obj = TestMimWebsocketParser
            ...
            header_expected = MimWebSocketParser.EncodeAsStruct('myModelName', '12345', '23456', [], []);
            jsonString = MimWebSocketParser.EncodeAsString('myModelName', '12345', '23456', metadata_expected, textvalue_expected);
            ...
            blob = MimWebSocketParser.EncodeAsBlob('myModelName', '12345', '23456', metadata_expected, value_expected);
            header_expected = MimWebSocketParser.EncodeAsStruct('myModelName', '12345', '23456', [], []);
