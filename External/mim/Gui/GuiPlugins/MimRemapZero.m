classdef MimRemapZero < MimGuiPlugin
    % MimRemapZero. Gui Plugin for setting paint colour to transparent
    %
    %     You should not use this class within your own code. It is intended to
    %     be used by the gui of the TD MIM Toolkit.
    %
    %     MimRemapZero is a Gui Plugin for the MIM Toolkit.
    %
    %
    %     Licence
    %     -------
    ...
    properties
        ButtonText = 'Erase'
        SelectedText = 'Erase'
        ToolTip = 'Removes airway tree from lobal mapping'
