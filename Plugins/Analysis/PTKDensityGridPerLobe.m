classdef PTKDensityGridPerLobe < PTKPlugin
    ...
    methods (Static)
        ...
        function SaveToFile(dataset, lobe_name, xc, yc, zc, density_values)
            ...
            MimSaveListOfPointsAndValues(results_directory, file_name, xc, yc, zc, density_values, coordinate_system, template_image);
        end        
    end
end