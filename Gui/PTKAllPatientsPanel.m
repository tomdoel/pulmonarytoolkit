classdef PTKAllPatientsPanel < GemCompositePanel
    ...
    methods (Access = private)
        ...
        function AddPatientPanels(obj)
            ...
            [names, ids, short_visible_names, num_series, num_patients_combined, patient_id_map] = obj.PatientDatabase.GetListOfPatientNamesAndSeriesCount(obj.GuiCallback.GetCurrentProject);
