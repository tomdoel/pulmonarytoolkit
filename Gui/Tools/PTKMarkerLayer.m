classdef PTKMarkerLayer < CoreBaseClass
    % PTKMarkerLayer. Part of the internal gui for the Pulmonary Toolkit.
    %
    %     You should not use this class within your own code. It is intended to
    %     be used internally within the gui of the Pulmonary Toolkit.
    %
    %     PTKMarkerLayer displays marker points over an image
    %
    %
    %     Licence
    %     -------
    ...
    methods
        function obj = PTKMarkerLayer(marker_image_source, marker_display_parameters, viewer_panel, axes)
    ...
    methods (Access = private)
        ...
        function new_marker = NewMarker(obj, coords, colour)
            ...
            new_marker = PTKMarkerPoint(coords, obj.Axes, colour, obj, obj.GetCoordinateLimits);
