classdef (Sealed) MivSplashScreen < CoreProgressInterface & PTKFigure
    ...
    %     is visible.
    %
    %     MivSplashScreen is a singleton. You cannot create it using the
    %     constructor; instead call MivSplashScreen.GetSplashScreen;
    %
    %
    %     Licence
    %     -------
    ...
    methods
        ...
        function CreateGuiComponent(obj, position)
            ...
            axis(obj.Image, 'off');
            obj.TitleText = uicontrol('Style', 'text', 'Units', 'Pixels', 'Position', [300, 210, 350, 75], 'String', MivSoftwareInfo.Name, 'FontName', PTKSoftwareInfo.GuiFont, 'FontUnits', 'pixels', 'FontSize', 40, 'FontWeight', 'bold', 'ForegroundColor', [0, 0.129, 0.278], 'BackgroundColor', [1 1 1]);
            ...
            set(obj.BodyText, 'String', sprintf(['Version ' MivSoftwareInfo.Version]));
